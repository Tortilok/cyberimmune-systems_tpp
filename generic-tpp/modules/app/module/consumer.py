...
def handle_event(id, details_str):
    ...
    if details['operation'] == 'update_settings':
        print('Меняем настройки')
        with open('/module/data/settings.json', 'w') as file:
            file.write(str(details['settings']))
        details['operation'] = 'send_message'
        details['message'] = {'new_settings': details['settings']}
    ...
    if details['operation'] == 'get_data':
        ...
        details['analog_data_app'] = analog_data
        details['discrete_data_app'] = discrete_data
        details['deliver_to'] = 'data-verifier'
